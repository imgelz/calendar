<div class="modal modal fade in" id="hapus-kategori" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background:#be0027">
                <center><h2 class="modal-title" style="color:#b1f547">Hapus Kategori</h2></center>
            ...
            <div class="modal-body" style="background:honeydew">
                ...
                <div class="form-group">
                  <label >Apakah Anda Ingin Menghapus Kategori Ini?</label>
                </div>
            </div>
