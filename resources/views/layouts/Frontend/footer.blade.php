<footer class="footer-area section-gap" style="background:#3f3e3e">
		<div class="container">
			<div class="row">
          ...
          <a class="navbar-brand logo_h d-none d-xl-block" href="index.html"><img src="/frontend/img/meetschedule.png" width="230px" alt=""></a>
				...
				<div class="col-xl-3 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
					<h4>Contact Info</h4>
					<ul>
						<li>Address: Holis Regency , Bandung -Jawa Barat 40048.</li>
						<li><a href="tel:+88044338899">Phone: +221 44338899</a></li>
						<li><a href="mailto:info@colorlib.com">Email: support@smooets.com</a></li>
					</ul>
				</div>
