<div class="modal modal fade in" id="hapus-log" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background:#be0027">
                <center><h2 class="modal-title" style="color:#b1f547">Hapus Logs</h2></center>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
            </div>
            <div class="modal-body" style="background:honeydew">
                <form id="form-hapus-log">
                    <input type="hidden" name="id" id="data-id-hapus" value="">
                <div class="form-group">
                  <label >Apakah Ingin Menghapus Log Activity Ini ?</label>
                </div>
            </div>
